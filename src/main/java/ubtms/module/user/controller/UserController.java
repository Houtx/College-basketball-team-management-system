...
public class UserController {
    ...
    public String mainPage(HttpServletRequest request, Model model) {
        ...
        if (role.equals("超级管理员")||role.equals("领队")){
            perssions = PermissionUtil.getPermission(menus, "人员管理");
        }else {
            perssions = PermissionUtil.getPermission(menus, "基本信息");
        }
        ...
        if (!request.getSession().getAttribute("loginRole").toString().equals("超级管理员")){
            perssions = PermissionUtil.getPermission(menus, "球队信息");
        ...
        int unReadMsg = communityService.getUnReadMsgNum(userId);
        request.getSession().setAttribute("unReadMsgNum",unReadMsg);
        return "/mainPage";
    }

    @RequestMapping("/userMngPage")
    public String userMngPage(HttpServletRequest request) {
        return "/user/userMng";
    }
    ...
    public Map<String, Object> userAccountValidate(@RequestBody User user, HttpServletRequest request) {
        ...
        if (success) {
            ...
            request.getSession().setAttribute("loginRole",  role.getRoleName());
    ...
    @ResponseBody
    public Map<String, Object> updatePsw(@RequestBody String[] str,HttpServletRequest request) {
        Map<String, Object> map = new HashMap<String, Object>();
