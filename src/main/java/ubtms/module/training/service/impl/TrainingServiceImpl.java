...
public class TrainingServiceImpl implements TrainingService {
    ...
    @Override
    public XSSFWorkbook exportExcel(TrainingDto trainingDto) {
        //创建excel工作簿
        ...
        for (int i = 5, j = 0; i <= 24 && j < trainingItemList.size(); i++, j++) {
            ...
            switch (i) {
                case 5:
                    dataRow.createCell(0).setCellValue("星期一");
                    break;
                case 9:
                    dataRow.createCell(0).setCellValue("星期二");
                    break;
                case 13:
                    dataRow.createCell(0).setCellValue("星期三");
                    break;
                case 17:
                    dataRow.createCell(0).setCellValue("星期四");
                    break;
                case 21:
                    dataRow.createCell(0).setCellValue("星期五");
                    break;
            }
            String type = "";
            String content = "";
