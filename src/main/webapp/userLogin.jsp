...
<div class="container" id="content">
    ...
    <div style="margin-left: auto;margin-right: auto;width: 600px;">
        <form class="form-horizontal" id="loginForm">
            <span class="heading" style="font-weight:600;">用户登录</span>
            <div class="form-group" style="margin-bottom: 0px">
                <input class="form-control" id="phone" name="phone" placeholder="帐 号">
                <i class="fa fa-user"></i>
                <span class="help-block errorMsg" id="phone-error"
                      style="margin-left: -360px;font-size: 14px">&nbsp;</span>
            </div>
            <div class="form-group help" style="margin-bottom: 0px">
                <input type="password" class="form-control" id="password" name="password" placeholder="密　码">
                <i class="fa fa-lock"></i>
                <a href="#" class="fa fa-question-circle"></a>
                <span class="help-block errorMsg" id="password-error"
                      style="margin-left: -360px;font-size: 14px">&nbsp;</span>
            </div>
