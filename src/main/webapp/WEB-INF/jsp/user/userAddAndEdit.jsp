            ...
            <form class="form-horizontal myForm" role="form" id="userForm" method="post" enctype="multipart/form-rows">
                ...
                <c:if test="${loginUser != 'admin'}">
                    <div style="display: none">
                        <div >
                            <input type="hidden" value="${loginSchool.schName}" class="form-control" id="schoolName" name="schoolName" data-provide="typeahead">
                            <span class="help-block errorMsg" id="schoolName-error">&nbsp;</span>
                        </div>
                    </div>
                </c:if>
                ...
                <div id="passwordDiv" class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="password" style="ime-mode:disabled" class="form-control" id="password" name="password">
                ...
                <div class="col-sm-10">
                    <div style=" margin-left: auto; margin-right: auto;">
                        <div style=" margin-left: auto; margin-right: auto;">
                            ...
                            <c:if test="${loginRole=='超级管理员'||loginRole=='领队'}">
