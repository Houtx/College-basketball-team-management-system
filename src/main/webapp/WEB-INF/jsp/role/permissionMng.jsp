...
<div class="container-fluid">
    ...
    <input type="button" class="btn btn-primary" id="btnOK" onclick="permissionMng.savePerssion()" value="确定" />
    <input type="button" class="btn btn-primary" onclick="permissionMng.back()" value="返回" />
</div>
