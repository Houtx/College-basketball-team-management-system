                ...
                <div class="panel-body">
                    <form id="formSearch" class="form-horizontal">
                        <div class="form-group" style="margin-top:15px">
                            ...
                            <label class="control-label col-sm-1" for="searchUserName">回复人</label>
                            <div class="col-sm-3">
                            ...
                            <div class="col-sm-4" style="text-align:left;">
                                <input type="button" style="margin-left:50px" class="btn btn-primary"
                                       onclick="replyMng.serachClick()" value="查询"/>
                            </div>
                        </div>
                    </form>
                </div>
...
<script src="resources/js/community/replyMng.js"></script>
