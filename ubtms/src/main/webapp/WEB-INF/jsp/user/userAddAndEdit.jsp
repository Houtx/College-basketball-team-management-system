			...
			<div class="row detailRow">
				<div class="col-xs-8 col-md-6 myColCenterBlock">
					...
					<form class="form-horizontal myForm" role="form" id="userForm" method="post" enctype="multipart/form-rows">
						...
						<div class="form-group" style="margin-top: 30px;">
							<label for="account" class="col-sm-2 control-label"><span class="requiredMsg">*</span>账号</label>
							<div class="col-sm-10">
						...
						<c:choose>
							<c:when test=$ {opType=="1" }>
								<div id="gradeDiv" class="form-group" style="margin-top: 30px;">
								...
								<div id="heightDiv" class="form-group" style="margin-top: 30px;">
								...
								<div id="weightDiv" class="form-group" style="margin-top: 30px;">
								...
								<div id="shirtNumDiv" class="form-group" style="margin-top: 30px;">
								...
								<div id="dutyDiv" class="form-group" style="margin-top: 30px;">
                    ...
                    <input type="radio" name="duty" id="CGRadio" value="1"> 控卫
							...
							<c:when test="${ (opType==" 2 "||opType=="3 ") && userType==1}">
								<div id="gradeDiv" class="form-group" style="margin-top: 30px;">
									<label for="grade" class="col-sm-2 control-label">年级</label>
									<div class="col-sm-10">
										<input type="text" class="form-control" id="grade" name="grade">
					...
					<div class="row">
						...
						<div class="col-sm-10">
							<div style=" margin-left: auto; margin-right: auto;">
								<div style=" margin-left: auto; margin-right: auto;">
									<input id="btnEdit" name="btnEdit" type="button" onclick="userDetail.userAdd.submitForm()" style="display:none;width: 100px;" class="btn btn-primary" value="编辑" />
									...
									<input type="button" onclick=" schoolDetail.schoolAdd.back()" style="width: 100px;" class="btn btn-primary" value="修改密码" />
								</div>
							</div>
						</div>
					</div>
